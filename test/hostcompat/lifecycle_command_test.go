...
func lifecycleToolName(id registry.Harness) string {
	if id == registry.Harness("claude") {
		return "Bash"
	}
	if id == registry.Harness("codex") {
		return "exec_command"
	}
	if id == registry.Harness("copilot") {
		return "bash"
	}
	...
	if id == registry.Harness("grok") {
		return "run_terminal_command"
	}
	if id == registry.Harness("droid") {
		return "Execute"
	}
	if id == registry.Harness("goose") {
		return "shell"
	}
	if id == registry.Harness("opencode") || id == registry.Harness("kilo") {
		return "bash"
	}
	if id == registry.Harness("openclaw") {
		return "exec"
	}
	if id == registry.Harness("pi") || id == registry.Harness("omp") {
		return "bash"
	}
	if id == registry.Harness("hermes") {
		return "terminal"
	}
	return "shell"
}
