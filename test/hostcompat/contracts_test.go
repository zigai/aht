...
var hostContracts = []hostContract{
	...
	{ID: registry.HarnessCursor, Executable: "agent", VersionArgs: []string{"--version"}, Level: compatibilityDiscovery, Docs: []string{"https://cursor.com/docs/cli/headless", "https://cursor.com/docs/cli/reference/authentication"}},
	...
	{ID: registry.HarnessCline, Executable: "cline", VersionArgs: []string{"--version"}, Level: compatibilityLifecycle, Protocol: protocolOpenAIChat, Docs: []string{"https://docs.cline.bot/cline-cli/overview", "https://docs.cline.bot/sdk/plugins"}},
	...
	{ID: registry.HarnessGoose, Executable: "goose", VersionArgs: []string{"--version"}, Level: compatibilityLifecycle, Protocol: protocolOpenAIChat, Docs: []string{"https://goose-docs.ai/docs/guides/context-engineering/hooks/", "https://goose-docs.ai/docs/guides/environment-variables/", "https://goose-docs.ai/docs/guides/goose-cli-commands/"}},
	...
	{ID: registry.HarnessOpenCode, Executable: "opencode", VersionArgs: []string{"--version"}, Level: compatibilityLifecycle, Protocol: protocolOpenAIChat, Docs: []string{"https://opencode.ai/v2/docs/build/plugins", "https://opencode.ai/docs/plugins/", "https://opencode.ai/docs/providers/#custom-provider"}},
	...
	{ID: registry.HarnessKilo, Executable: "kilo", VersionArgs: []string{"--version"}, Level: compatibilityLifecycle, Protocol: protocolOpenAIChat, Docs: []string{"https://kilo.ai/docs/code-with-ai/platforms/cli-reference", "https://kilo.ai/docs/automate/extending/plugins"}},
